...
#include "vura-playlist-private.h"
...
bool PlaylistPrivate::checkFormat(const char *format) const
{
    ...
    PlaylistFileParser::FileType type =
            format ? PlaylistFileParser::UNKNOWN : PlaylistFileParser::M3U8;
    if (format) {
...
void PlaylistPrivate::ensureParser()
{
    ...
    QObject::connect(parser, &PlaylistFileParser::error, q_ptr,
                     [this](Playlist::Error err, const QString &errorMsg) {
