...
void Updater::startDownload(const QString &downloadUrl, const QString &expectedHash)
{
    ...
    connect(m_currentReply, &QNetworkReply::readyRead, this, &Updater::onReadyRead);
    connect(m_currentReply, &QNetworkReply::finished, this, &Updater::onFinished);
}

void Updater::onDownloadProgress(const qint64 bytesReceived, const qint64 bytesTotal)
{
...
bool Updater::verifyFileIntegrity() {
...
void Updater::executeInstaller() const
{
#if defined(Q_OS_WIN)
