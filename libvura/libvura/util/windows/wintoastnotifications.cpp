#include "wintoastnotifications.h"
...
using namespace WinToastNotifications;

void WinToastNotifications::setDebugOutputEnabled(bool enabled) {
...
bool WinToastNotifications::WinToast::isSupportingModernFeatures() {
    constexpr auto MinimumSupportedVersion = 6;
    return Util::getRealOSVersion().dwMajorVersion > MinimumSupportedVersion;
}

bool WinToastNotifications::WinToast::isWin10AnniversaryOrHigher() {
...
void WinToastNotifications::WinToastTemplate::setScenario(_In_ Scenario scenario) {
    switch (scenario) {
...
std::wstring const& WinToastNotifications::WinToastTemplate::scenario() const {
    return _scenario;
}
