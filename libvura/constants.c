...
std::string _applicationDebugFolder = QStandardPaths::writableLocation(QStandardPaths::HomeLocation);

std::string _videoFileExtensions = R"(
...
std::string _audioFileExtensions = R"(
...
std::string _applicationFileExtensions = R"(
*.vhk *.vprj *vvm
)";

std::string _playlistFileExtensions = R"(
