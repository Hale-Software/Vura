...
invoke_formatter() {
  ...
  case ${formatter} {
    clang)
      ...
      if (( ! #source_files )) source_files=((libh|libh-*|UI|deps|shared|test)/**/*.(c|cpp|h|hpp|m|mm)(.N))
    ...
    gersemi)
      ...
      if (( ! #source_files )) source_files=(CMakeLists.txt (libh|libh-*|UI|deps|shared|cmake|test)/**/(CMakeLists.txt|*.cmake)(.N))
    ...
    swift)
      ...
      if (( ! #source_files )) source_files=((libh|libh-*|UI)/**/*.swift(.N))
