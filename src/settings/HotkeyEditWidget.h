...
public:
    explicit HotkeyEditWidget(int id, QString action, QString defaultHotkey, QString hotkey, QWidget *parent = nullptr);
    ~HotkeyEditWidget() override;
