...
VuraStartup::VuraStartup() {}

bool VuraStartup::Initialize(bool initDirectories, bool initApplicationFiles)
{
...
void VuraStartup::InitDirectories()
{
...
void VuraStartup::InitApplicationFiles()
{
    QSettings settings;
...
bool VuraStartup::createEmptyJsonFile(const QString &filePath)
{
